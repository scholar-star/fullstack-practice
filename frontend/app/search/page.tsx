...
export default function SearchPage() {
  ...
  const filtered: Post[] = results.filter((post) => {
    const standardQuery = query.trim().toLowerCase();
    if (standardQuery === "") return true;
    return (post.title.toLowerCase().includes(standardQuery) ||
            post.content.toLowerCase().includes(standardQuery));
  })
